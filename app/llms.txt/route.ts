...
- Wallet for chat clients: \`npx onchainrouter wallet\` (MCP server; \`call_paid_tool\` calls a router tool and pays in one step, \`sign_x402_payment\` signs any x402 request). With it, the router does not need to be added separately.
